  ...
  <div class="bg-white p-4 rounded-lg shadow animate-fade-in-down">
    ...
    <table class="table-auto w-full">
      ...
      <tr>
        ...
        <TableHeaderCell field="isSpecial" :sort-field="sortField" :sort-direction="sortDirection"
                         @click="sortCategories('isSpecial')">
          Special Category
        </TableHeaderCell>
        <TableHeaderCell field="price" :sort-field="sortField" :sort-direction="sortDirection"
                         @click="sortCategories('price')">
          Price
        </TableHeaderCell>
      ...
      <tr v-for="(category, index) of categories.data">
        ...
        <td class="border-b p-2">
          {{ category.isSpecial ? 'Yes' : 'No' }}
        </td>
        <td class="border-b p-2">
          {{ $filters.currencyPHP(category.price) }}
        </td>
        <!-- <td class="border-b p-2">
