            ...
            <DialogPanel
              ...
              <form @submit.prevent="onSubmit">
                <div class="bg-white px-4 pt-5 pb-4">
                  ...
                  <CustomInput type="number" class="mb-2" v-model="category.price" label="Fix Price" prepend="₱" :errors="errors['price']" required/>
                  ...
                  <CustomInput type="checkbox" class="mb-2" v-model="category.isSpecial" label="Special Category"  :errors="errors['Special']"/>
                </div>
...
const category = ref({
  ...
  isSpecial: props.category.isSpecial,
