...
<body onload="window.print()">
    <div class="report-header">
        <h5 class="text-bold text-uppercase heading-2" style="vertical-align:middle;text-align:center">Metro North Day by
            Day Jesus Ministries Inc.</h5>
        <h1 class="text-bold text-uppercase heading-1" style="vertical-align:middle;text-align:center"> Young
            Professional Ministries<br>Fund Raising Event</h1>
    ...
    <table class="table-details">
        ...
        @if (count($order->items))
            @foreach ($order->items as $item)
                <tr>
                    <td class="td-2" style="vertical-align:middle;text-align:center">
                        {{ $item->product->product_code }}</td>
                    <td class="td-2" style="vertical-align:middle;text-align:center">{{ $item->product->title }}</td>
                    <td class="td-2" style="vertical-align:middle;text-align:center">
                        {{ html_entity_decode(strip_tags($item->product->description)) }}</td>
    ...
    <table class="table-footer">
        <tr>
            <td class="text-center">I hereby certify that the item/s and circumstances stated above are true and correct
            </td>
        ...
        <tr>
            <td class="text-center"><span id="span2">Signature over Printed Name of the Accountable Officer</span>
            </td>
        </tr>
        <tr>
