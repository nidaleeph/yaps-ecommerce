    ...
    <div class="block fixed z-10 top-0 bottom-0 height h-full w-[220px] transition-all bg-slate-900 xl:hidden"
        ...
        <ul>
            ...
            <li x-data="{open: false}" class="relative">
                ...
                <ul x-show="open" x-transition class="z-10 right-0 bg-slate-800 py-2"  @mouseenter="open = true" @mouseleave="open = false">
                    <li>
        ...
        <ul class="grid grid-flow-col items-center">
            ...
            <li x-data="{open: false}" class="relative">
                ...
                <ul @mouseenter="open = true" @mouseleave="open = false" @click.outside="open = false" x-show="open"
                    x-transition x-cloak class="absolute z-10 right-100 bg-slate-800 py-2 w-48">
                    <li>
                        <a href="{{ route('profile') }}" class="flex px-3 py-2 hover:bg-slate-900">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor" stroke-width="2">
            ...
            <li x-data="{open: false}" class="relative">
                ...
                <ul @mouseenter="open = true" @mouseleave="open = false" @click.outside="open = false" x-show="open"
                    x-transition x-cloak class="absolute z-10 right-0 bg-slate-800 py-2 w-48">
                    <li>
                        <a href="{{ route('profile') }}" class="flex px-3 py-2 hover:bg-slate-900">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor" stroke-width="2">
