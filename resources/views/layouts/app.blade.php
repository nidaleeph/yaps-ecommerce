...
<script>
    $(document).ready(function() {
        ...
        function handleAnimation() {
            $(".slide-in, .fade-in, .slide-up, .slide-left, .slide-right, .slide-down, .visible").each(
                function() {
                    if (isInViewport(this, 100)) { // Using a positive offset of 50px
                        // console.log('Element is in viewport:', this);
                        $(this).addClass("active");
                    }
                    // else {
                    //     console.log('Element is not in viewport. Rect:', this.getBoundingClientRect());
                    // }
                });
        }
